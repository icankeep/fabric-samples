...
function createOrg3 {
  ...
  infoln "Registering user A"
  set -x
  fabric-ca-client register --caname ca-org3 --id.name usera --id.secret userapw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering user B"
  set -x
  fabric-ca-client register --caname ca-org3 --id.name userb --id.secret userbpw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user A msp"
  set -x
	fabric-ca-client enroll -u https://usera:userapw@localhost:11054 --caname ca-org3 -M "${PWD}/organizations/peerOrganizations/org3.example.com/users/usera@org3.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/org3.example.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/org3.example.com/users/usera@org3.example.com/msp/config.yaml"

  infoln "Generating the user B msp"
  set -x
	fabric-ca-client enroll -u https://userb:userbpw@localhost:11054 --caname ca-org3 -M "${PWD}/organizations/peerOrganizations/org3.example.com/users/userb@org3.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/org3.example.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/org3.example.com/users/userb@org3.example.com/msp/config.yaml"
