...
echo "network restart and deploying chaincode"
./network.sh down && ./network.sh up createChannel -ca &&  ./network.sh deployCC -ccn basic -ccp ../asset-transfer-basic/chaincode-java -ccl java
